...
public class View {
	private TicTacToe actionListener;
    ...
    public void setActionListener(Controller c) {
    		// actionListener needs reference of controller and view class
		this.actionListener = new TicTacToe(c,this);
		
	
		for(int row = 0; row<3 ;row++) {
	        for(int column = 0; column<3 ;column++) {
	        	
	        		blocks[row][column].addActionListener(actionListener);
	        }
		}
